...
const BusList = ({ token }) => {
  ...
  useEffect(() => {
    const fetchBuses = async () => {
      try {
        ...
        console.error('error in fetching buses', error)
  ...
  // Optional: format time string (HH:mm:ss) to HH:mm
              ...
              <div className="p-6">
                ...
                <div className="mt-4">
                  ...
                  <div className="flex items-center text-gray-600 mb-2">
                    ...
                    <span>Depart: {formatTime(bus.start_time)}</span>
                  </div>
                  ...
                  <div className="flex items-center text-gray-600 mb-2">
                    ...
                    <span>Arrive: {formatTime(bus.reach_time)}</span>
                  </div>

                  {bus.current_location && (
                    <p className="text-sm text-gray-600 mt-2"><strong>Current Location:</strong> {bus.current_location}</p>
                  )}

                  {bus.route_info && (
                    <p className="text-sm text-gray-600 mt-1"><strong>Route Info:</strong> {bus.route_info}</p>
                  )}

                  {bus.features && (
                    <p className="text-sm text-gray-600 mt-1"><strong>Features:</strong> {bus.features}</p>
                  )}
                </div>
